...
- Creating a new character adds that character to the database (not just github)
- Delete character functionality (database and storage)
- Modules page shows cards per module
