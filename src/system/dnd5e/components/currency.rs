			...
			<div>
				<div class="d-flex">
					...
					<span class="ms-2" style="font-size: 0.8rem;">
						...
						{total_value_gold}
						{" GP"}
						<span class="ms-1"><CoinIcon kind={currency::Kind::Gold}/></span>
						{")"}
					</span>
				</div>
